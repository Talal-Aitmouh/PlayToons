      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden bg-black backdrop-blur-md border-b border-gray-800"
          >
            ...
            <div className="px-4 py-3 border-t border-gray-700">
              <div className="relative">
                <input
                  ...
                  value={searchQuery}
                  onChange={handleSearchChange}
                  className="w-full pl-10 pr-4 py-2 bg-black text-white rounded-md border border-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                />
